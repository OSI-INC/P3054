...
-- Module  Version: 3.5
--C:\lscc\diamond\3.12\ispfpga\bin\nt64\scuba.exe -w -n SMADD -lang vhdl -synth synplify -bus_exp 7 -bb -arch xo2c00 -type add -width 18 -unsigned -pipeline 0 
...
begin
    ...
    addsub_8: FADD2B
        port map (A0=>DataA(15), A1=>DataA(16), B0=>DataB(15), 
            B1=>DataB(16), CI=>co7, COUT=>co8, S0=>Result(15), 
            S1=>Result(16));
    ...
    addsub_9: FADD2B
        port map (A0=>DataA(17), A1=>scuba_vlo, B0=>DataB(17), 
            B1=>scuba_vlo, CI=>co8, COUT=>open, S0=>Result(17), S1=>open);
