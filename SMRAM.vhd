...
-- Module  Version: 7.5
--C:\lscc\diamond\3.12\ispfpga\bin\nt64\scuba.exe -w -n SMRAM -lang vhdl -synth synplify -bus_exp 7 -bb -arch xo2c00 -type bram -wp 10 -rp 1000 -addr_width 2 -data_width 18 -num_rows 4 -cascade 11 -mem_init0 -writemode NORMAL 
...
architecture Structure of SMRAM is
    ...
    attribute MEM_LPC_FILE of SMRAM_0_0_0_0 : label is "SMRAM.lpc";
    attribute MEM_INIT_FILE of SMRAM_0_0_0_0 : label is "INIT_ALL_0s";
...
begin
    ...
    SMRAM_0_0_0_0: DP8KC
        ...
        port map (DIA8=>Data(8), DIA7=>Data(7), DIA6=>Data(6), 
            ...
            ADA8=>scuba_vlo, ADA7=>scuba_vlo, ADA6=>scuba_vlo, 
            ADA5=>scuba_vlo, ADA4=>Address(1), ADA3=>Address(0), 
            ...
            RSTA=>Reset, DIB8=>Data(17), DIB7=>Data(16), DIB6=>Data(15), 
            DIB5=>Data(14), DIB4=>Data(13), DIB3=>Data(12), 
            DIB2=>Data(11), DIB1=>Data(10), DIB0=>Data(9), 
            ADB12=>scuba_vhi, ADB11=>scuba_vlo, ADB10=>scuba_vlo, 
            ADB9=>scuba_vlo, ADB8=>scuba_vlo, ADB7=>scuba_vlo, 
            ADB6=>scuba_vlo, ADB5=>scuba_vlo, ADB4=>Address(1), 
            ADB3=>Address(0), ADB2=>scuba_vlo, ADB1=>scuba_vlo, 
            ADB0=>scuba_vhi, CEB=>ClockEn, OCEB=>ClockEn, CLKB=>Clock, 
            WEB=>WE, CSB2=>scuba_vlo, CSB1=>scuba_vlo, CSB0=>scuba_vlo, 
            RSTB=>Reset, DOA8=>Q(8), DOA7=>Q(7), DOA6=>Q(6), DOA5=>Q(5), 
            DOA4=>Q(4), DOA3=>Q(3), DOA2=>Q(2), DOA1=>Q(1), DOA0=>Q(0), 
            DOB8=>Q(17), DOB7=>Q(16), DOB6=>Q(15), DOB5=>Q(14), 
            DOB4=>Q(13), DOB3=>Q(12), DOB2=>Q(11), DOB1=>Q(10), 
            DOB0=>Q(9));
...
-- synopsys translate_off
library MACHXO2;
configuration Structure_CON of SMRAM is
    for Structure
