...
-- Module  Version: 5.8
--C:\lscc\diamond\3.12\ispfpga\bin\nt64\scuba.exe -w -n CMD_FIFO -lang vhdl -synth synplify -bus_exp 7 -bb -arch xo2c00 -type ebfifo -depth 1024 -width 8 -rwidth 8 -no_enable -pe 2 -pf 1020 

-- Thu Apr 02 14:22:34 2026
...
begin
    ...
    CMD_FIFO_0_0: FIFO8KB
        generic map (FULLPOINTER1=> "0b01111111111000", FULLPOINTER=> "0b10000000000000", 
        AFPOINTER1=> "0b01111111011000", AFPOINTER=> "0b01111111100000", 
        AEPOINTER1=> "0b00000000011000", AEPOINTER=> "0b00000000010000", 
...
-- synopsys translate_off
library MACHXO2;
configuration Structure_CON of CMD_FIFO is
    for Structure
