...
-- Module  Version: 6.5
--C:\lscc\diamond\3.12\ispfpga\bin\nt64\scuba.exe -w -n SPS_RAM -lang vhdl -synth synplify -bus_exp 7 -bb -arch xo2c00 -type bram -wp 10 -rp 0011 -rdata_width 18 -data_width 18 -num_rows 512 -cascade 11 -mem_init0 
...
architecture Structure of SPS_RAM is
    ...
    attribute MEM_LPC_FILE of SPS_RAM_0_0_0_0 : label is "SPS_RAM.lpc";
    attribute MEM_INIT_FILE of SPS_RAM_0_0_0_0 : label is "INIT_ALL_0s";
...
-- synopsys translate_off
library MACHXO2;
configuration Structure_CON of SPS_RAM is
    for Structure
